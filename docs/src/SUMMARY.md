...
- [Layout Overview](./dev-guide/layout/overview.md)
- [Mutation Pipeline](./dev-guide/layout/pipeline.md)
- [Mutations Catalog](./dev-guide/layout/mutations.md)
- [Projection: Parking & Padding](./dev-guide/layout/projection.md)
...
- [Loadout Save/Restore](./dev-guide/loadout.md)
- [Self-Update](./dev-guide/updater.md)

## Reference

- [Design Decisions](./dev-guide/design-decisions.md)
