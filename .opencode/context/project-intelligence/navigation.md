<!-- Context: project-intelligence/nav | Priority: critical | Version: 2.0 | Updated: 2026-06-05 -->
...
| Understand the "how" | `technical-domain.md` | Rust stack, mutation pipeline, module structure, naming, standards (v2.0) |
